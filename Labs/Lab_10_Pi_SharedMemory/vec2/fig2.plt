...
plot 'speedupVector2.dat' u 1:2 w p pt 7 ps 2.5 lc rgb "red" t 'Escalabilidad \texttt{vector.cpp}',\
...
set output
system('latex Figure2.tex')
system('dvips Figure2.dvi')
system('ps2pdf Figure2.ps')
system('rm Figure2.tex Figure2.log Figure2.aux Figure2-inc.eps Figure2.dvi Figure2.ps')
